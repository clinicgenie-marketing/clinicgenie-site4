...
export const SPECIALTY_HUB_WORKS: CaseStudy[] = [
  {
    ...
    heroHighlight: "clinical care, not wellness",
  ...
  },
  {
    ...
    snapshot: {
      ...
      mainChallenge:
        "A rare depth of surgical credentials and a broad clinical scope, in a category where aesthetics dominate the search results. MSDC is a medical practice led by a Mohs surgeon. The work had to make that scope legible while still serving the everyday eczema patient at the same door.",
  ...
  },
  {
    ...
    heroHighlight: "Three decades of practice",
    ...
    snapshot: {
      ...
      projectFocus: "Brand and voice, website architecture, condition structure, healthcare SEO, paid search",
      mainChallenge:
        "A neurosurgeon with three decades of practice and international fellowship training, an enormous clinical scope, and patients arriving in the worst week of their lives.",
      role: "Brand, copywriting, website structure, condition architecture, search planning, content direction, and SEM",
    },
    beforeIntro:
      "A neurosurgeon with three decades of practice and international fellowship training, an enormous clinical scope, and patients arriving in the worst week of their lives.",
