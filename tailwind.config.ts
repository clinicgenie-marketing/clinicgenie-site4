  ...
  theme: {
    extend: {
      ...
      fontSize: {
        ...
        base:   ["var(--text-body)", { lineHeight: "1.7" }],
        lg:     ["var(--text-h5)", { lineHeight: "1.4" }],
        xl:     ["var(--text-h4)", { lineHeight: "1.35" }],
        "2xl":  ["var(--text-h3)", { lineHeight: "1.25" }],
        "3xl":  ["var(--text-h2)", { lineHeight: "1.2" }],
        "4xl":  ["var(--text-h1)", { lineHeight: "1.15" }],
        "5xl":  ["var(--text-display)", { lineHeight: "1.12" }],
        ...
        h3:     ["var(--text-h3)", { lineHeight: "1.25", letterSpacing: "-0.01em", fontWeight: "600" }],
        h2:     ["var(--text-h2)", { lineHeight: "1.2", letterSpacing: "-0.015em", fontWeight: "700" }],
        h1:     ["var(--text-h1)", { lineHeight: "1.15", letterSpacing: "-0.02em", fontWeight: "700" }],
      },
      spacing: {
        section:    "6rem",
        "section-lg": "10rem",
