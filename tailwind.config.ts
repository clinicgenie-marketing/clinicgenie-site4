  ...
  theme: {
    extend: {
      ...
      fontSize: {
        ...
        "3xl":  ["var(--text-h2)", { lineHeight: "1.12" }],
        "4xl":  ["var(--text-h1)", { lineHeight: "1.05" }],
        "5xl":  ["var(--text-display)", { lineHeight: "1" }],
        ...
        h3:     ["var(--text-h3)", { lineHeight: "1.2", letterSpacing: "-0.01em", fontWeight: "600" }],
        h2:     ["var(--text-h2)", { lineHeight: "1.12", letterSpacing: "-0.015em", fontWeight: "700" }],
